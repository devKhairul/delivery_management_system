    ...
    <nav class="navbar navbar-expand-sm navbar-default">
        <div id="main-menu" class="main-menu collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="tickets.php"> <i class="menu-icon fa fa-file"></i>OPEN TICKET </a>
                </li>

                <li>
                    <a href="tickets-list.php"> <i class="menu-icon fa fa-list-alt"></i>MY TICKETS </a>
                </li>
    ...
    <header id="header" class="header">
        <div class="top-left">
            <div class="navbar-header">
                <a class="navbar-brand" href="./"><img src="images/logo-s.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="images/logo-s.png.png" alt="Logo"></a>
